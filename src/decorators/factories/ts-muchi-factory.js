...
var TsMuchiDecoratorFactory = /** @class */ (function () {
    function TsMuchiDecoratorFactory(beforeRegistry, methodRegistry, afterRegistry, mockRegistry) {
    ...
    TsMuchiDecoratorFactory.prototype.create = function () {
        var _this = this;
        return function (_a) {
            var name = _a.name, ignore = _a.ignore;
            return function (testClass) {
                ...
                var tsMuchiTestRunner = new ts_muchi_test_runner_1.default(_this.beforeRegistry, _this.methodRegistry, _this.afterRegistry, _this.mockRegistry);
                tsMuchiTestRunner
                    .run(runnerOpts)
                    .then(function () { return runnerOpts.logger.log(); })
                    .catch(console.error);
            };
        };
    };
